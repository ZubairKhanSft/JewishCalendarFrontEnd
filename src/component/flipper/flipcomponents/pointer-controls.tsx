...
import { useMergePointerEvents } from "../hooks/merge-pointer-events.ts";
import {
  usePointerEvents,
  UsePointerEventsOnMoveOptions,
  UsePointerEventsOnUpOptions,
} from "../hooks/pointer-events.ts";
import { getCurrSelected, getNextSelected } from "../utils/pointer-controls.ts";
...
export const defaultSwipeSpeed = 0.2;
